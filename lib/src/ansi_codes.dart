...
class AnsiCodes {
  ...
  static String CSI_CUU(int n) => '$ESC_CSI${n}A'; // Cursor Up
  static String CSI_CUD(int n) => '$ESC_CSI${n}B'; // Cursor Down
  static String CSI_CUF(int n) => '$ESC_CSI${n}C'; // Cursor Forward
  static String CSI_CUB(int n) => '$ESC_CSI${n}D'; // Cursor Backward
  static String CSI_CNL(int n) => '$ESC_CSI${n}E'; // Cursor Next Line
  static String CSI_CPL(int n) => '$ESC_CSI${n}F'; // Cursor Previous Line
  ...
  static String CSI_SU(int n) => '$ESC_CSI${n}S'; // Scroll Up
  static String CSI_SD(int n) => '$ESC_CSI${n}T'; // Scroll Down
